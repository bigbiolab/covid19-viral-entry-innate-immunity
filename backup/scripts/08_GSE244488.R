...
col_data <- data.frame(
  row.names = samples,
  sample    = samples,
  condition = c("infected_total_cov_depleted", "infected_total_cov_depleted", "infected_total_cov_depleted",
                "bystander_total_cov_depleted", "bystander_total_cov_depleted", "bystander_total_cov_depleted",
                "mock_total_cov_depleted", "mock_total_cov_depleted", "mock_total_cov_depleted",
                "infected_total_cov_depleted", "infected_total_cov_depleted", "infected_total_cov_depleted",
                "infected_total_cov_depleted", "infected_total_cov_depleted", "infected_total_cov_depleted",
                "bystander_total_cov_depleted", "bystander_total_cov_depleted", "bystander_total_cov_depleted",
                "bystander_total_cov_depleted", "bystander_total_cov_depleted", "bystander_total_cov_depleted",
                "mock_total_cov_depleted", "mock_total_cov_depleted", "mock_total_cov_depleted",
                "mock_total_cov_depleted", "bystander_total_cov_depleted", "mock_total_cov_depleted",
                "infected_total", "infected_total", "infected_total",
                "infected_total", "infected_total", "infected_total",
                "bystander_total", "bystander_total", "bystander_total",
                "bystander_total", "bystander_total", "mock_total",
                "mock_total", "mock_total", "mock_total",
                "mock_total", "mock_total", "infected_total")
)
...
write.csv(annotated_res, "outputs/DESeq2/GSE244488_deseq2_results.csv", row.names = FALSE)
