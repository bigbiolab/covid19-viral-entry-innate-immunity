...
col_data <- data.frame(
  row.names = samples,
  sample    = samples,
  condition = c("alv_wt", "alv_x484", "alv_x1371", "alv_wt", "alv_x484", "alv_x1371",
                "alv_wt", "alv_x484", "alv_x1371", "air_wt", "air_x484", "air_x1371",
                "air_wt", "air_x484", "air_x1371", "air_wt", "air_x484", "air_x1371")
)
